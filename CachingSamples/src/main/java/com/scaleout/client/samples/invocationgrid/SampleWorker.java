...
public class SampleWorker {
    public static void main(String[] args) throws GridConnectException {
        InvocationWorker worker = new InvocationWorkerBuilder(new SampleInvocationGridStartup()).build();
